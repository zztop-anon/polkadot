...
function createKey(registry, itemFn, keys, hashers, args) {
  ...
  return (0, _util.compactAddLength)((0, _util.u8aConcat)(createPrefixedKey(itemFn), ...keys.map((type, index) => {
...
function createFunction(registry, itemFn, options) {
  ...
  const storageFn = expandWithMeta(itemFn, arg => type.isDoubleMap ? createKey(registry, itemFn, [type.asDoubleMap.key1, type.asDoubleMap.key2], [(0, _getHasher.getHasher)(type.asDoubleMap.hasher), (0, _getHasher.getHasher)(type.asDoubleMap.key2Hasher)], arg) : type.isMap ? createKey(registry, itemFn, [type.asMap.key], [(0, _getHasher.getHasher)(type.asMap.hasher)], [arg]) : options.skipHashing ? (0, _util.compactAddLength)((0, _util.u8aToU8a)(options.key)) : createKey(registry, itemFn, [], [], []));
